...
dlg.addField('# trials', initial='20')
dlg.addText('Porcentaje de "go"*')
dlg.addField('Porcentaje go:',initial='50')
dlg.addText('Porcentaje de "distractor"*')
dlg.addField('Porcentaje distractor:',initial='30')
id_inf = dlg.show()
...
output_file_path = '%s_%s_%s.csv'%(subid,ntrial,porc) #ubicación
...
for n in range(ntrial):
    if n<ntrial/2:
        dist_sequence.append(randrange(1,5,1))
    else:
        dist_sequence.append(randrange(6,9,1))

nan_idx = np.random.permutation(ntrial)
for n in nan_idx[:int(ntrial*porc_dist/100)]:
    dist_sequence[n] = np.nan
shuffle(dist_sequence)
print(dist_sequence)
...
# distract event
dist_1 = visual.TextStim(win, text='1',
                        font = 'Arial',
                        height = fontsize,
                        color = (255,0,0),
                        anchorHoriz = 'center',
                        anchorVert = 'center',
                        pos=(0.0,0.0))
dist_2 = visual.TextStim(win, text='2',
                        font = 'Arial',
                        height = fontsize,
                        color = (255,0,0),
                        anchorHoriz = 'center',
                        anchorVert = 'center',
                        pos=(0.0,0.0))
dist_3 = visual.TextStim(win, text='3',
                        font = 'Arial',
                        height = fontsize,
                        color = (255,0,0),
                        anchorHoriz = 'center',
                        anchorVert = 'center',
                        pos=(0.0,0.0))
dist_4 = visual.TextStim(win, text='4',
                        font = 'Arial',
                        height = fontsize,
                        color = (255,0,0),
                        anchorHoriz = 'center',
                        anchorVert = 'center',
                        pos=(0.0,0.0))
dist_5 = visual.TextStim(win, text='5',
                        font = 'Arial',
                        height = fontsize,
                        color = (255,0,0),
                        anchorHoriz = 'center',
                        anchorVert = 'center',
                        pos=(0.0,0.0))
dist_6 = visual.TextStim(win, text='6',
                        font = 'Arial',
                        height = fontsize,
                        color = (255,0,0),
                        anchorHoriz = 'center',
                        anchorVert = 'center',
                        pos=(0.0,0.0))
dist_7 = visual.TextStim(win, text='7',
                        font = 'Arial',
                        height = fontsize,
                        color = (255,0,0),
                        anchorHoriz = 'center',
                        anchorVert = 'center',
                        pos=(0.0,0.0))
dist_8 = visual.TextStim(win, text='8',
                        font = 'Arial',
                        height = fontsize,
                        color = (255,0,0),
                        anchorHoriz = 'center',
                        anchorVert = 'center',
                        pos=(0.0,0.0))
dist_9 = visual.TextStim(win, text='9',
                        font = 'Arial',
                        height = fontsize,
                        color = (255,0,0),
                        anchorHoriz = 'center',
...
elapse_time = 0
last_trial_dur = 0
image = visual.ImageStim(win, image="C:/Users/54115/Desktop/Doctorado/Neuro Cognitiva/puntitos.png")
...
for trial in range(ntrial):
    ...
    stim_onset = elapse_time + fixation_dur + dist_dur + blank_dur_pre
    blank_onset = elapse_time + fixation_dur + dist_dur + blank_dur_pre + stim_dur
    response_onset = elapse_time + fixation_dur + dist_dur + blank_dur_pre + stim_dur + blank_dur     
